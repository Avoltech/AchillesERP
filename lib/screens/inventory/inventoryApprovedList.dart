...
class InventoryApprovedList extends StatefulWidget {
  final User user;
  InventoryApprovedList({Key key, this.user}) : super(key: key);

  @override
  _InventoryApprovedListState createState() => _InventoryApprovedListState();
}

class _InventoryApprovedListState extends State<InventoryApprovedList> {

  Future _data;

  Future getForms(String uid) async {
    QuerySnapshot qs1 = await Firestore.instance.collection('forms').where('inventoryApproval', isEqualTo: 1).getDocuments();
